...
export default function Hero() {
  return (
    <section id="home" className="w-full bg-gradient-to-b from-primary/5 to-background py-20 md:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button className="bg-primary hover:bg-primary/90 text-white px-8 py-6 text-base font-semibold flex items-center gap-2">
                Solicite Orçamento
          ...
          {/* Right Image */}
          <div className="relative h-96 md:h-full min-h-96 rounded-2xl overflow-hidden shadow-lg fade-in">
            <img
