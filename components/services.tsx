...
export default function Services() {
  ...
  return (
    <section id="services" className="w-full py-20 md:py-32 bg-primary/5" aria-labelledby="services-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <header className="text-center mb-16 fade-in">
          <h2 id="services-heading" className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 text-balance">
            Nossos Serviços
          </h2>
            ...
            return (
              ...
              >
                <div className="w-14 h-14 bg-primary/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary group-hover:text-white transition-all duration-300">
                  <Icon className="w-7 h-7 text-primary group-hover:text-white transition-colors" aria-hidden="true" />
                </div>
        ...
        {/* CTA Section */}
        <aside className="mt-16 bg-white rounded-2xl p-8 md:p-12 border border-border text-center fade-in">
          ...
          <a
            ...
            aria-label="Ligar agora para Lincare Saúde"
          >
            Ligar Agora
          </a>
        </aside>
